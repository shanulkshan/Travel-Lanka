        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              We're here to help make your Sri Lankan adventure unforgettable
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      info@travellanka.com<br/>
                      support@travellanka.com
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="w-10 h-10 bg-red-500 text-white rounded-lg flex items-center justify-center hover:bg-red-600 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
