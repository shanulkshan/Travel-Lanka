      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Travel Lanka</h3>
                <p className="text-sm text-gray-400">Explore Sri Lanka</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Discover the beauty of Sri Lanka with our comprehensive travel management platform. 
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="text-gray-400 text-sm">
            © 2025 Travel Lanka. All rights reserved.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <span className="text-gray-400 text-sm">Made with ❤️ in Sri Lanka</span>
          </div>
        </div>
      </div>
    </footer>
